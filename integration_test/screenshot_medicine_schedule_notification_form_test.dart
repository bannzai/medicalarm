  ...
  group('end-to-end test', () {
    ...
    for (final locale in locales) {
      testWidgets('screenshot notification setting $locale', (tester) async {
        ...
        await tester.pumpWidget(
          ProviderScope(
            ...
            child: MaterialApp(
              ...
              locale: locale,
              home: const ScreenshotMedicineScheduleNotificationFormPage(),
        ...
        await tester.pumpAndSettle();
        await binding.takeScreenshot('artifacts/screenshots/screenshot_medicine_schedule_notification_form--${locale.languageCode}.png');
      });
    }
  });
}
