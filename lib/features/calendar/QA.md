...
- [x] **過去月のプレミアム制限（表示）**: 非課金ユーザーが前月以前へ移動すると、達成率カードが鍵アイコン付きの「プレミアムプランの加入で閲覧が可能です」リンクに置き換わり、日別の達成ドットも表示されない
- [x] **過去月のプレミアム制限（導線）**: 上記リンクのタップでプレミアム紹介シートが開く
- [x] **今月は制限なし**: 非課金ユーザーでも今月の達成率カードと日別ドットは表示される
...
### **過去月のプレミアム制限（表示）**: 非課金ユーザーが前月以前へ移動すると、達成率カードが鍵アイコン付きの「プレミアムプランの加入で閲覧が可能です」リンクに置き換わり、日別の達成ドットも表示されない
...
### **過去月のプレミアム制限（導線）**: 上記リンクのタップでプレミアム紹介シートが開く
...
### **今月は制限なし**: 非課金ユーザーでも今月の達成率カードと日別ドットは表示される
