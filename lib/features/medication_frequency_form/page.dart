                              ...
                              EveryXDaysMedicationFrequency() => MedicationFrequencyFormSectionLayout(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      onTap: () async {
                                        analytics.logEvent(name: 'med_freq_interval_tapped');
                              ...
                              CycleMedicationFrequency() => MedicationFrequencyFormSectionLayout(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      trailing: const Icon(Icons.chevron_right),
                                      onTap: () async {
                                        analytics.logEvent(name: 'med_freq_consecutive_tapped');
                                    ...
                                    ListTile(
                                      ...
                                      trailing: const Icon(Icons.chevron_right),
                                      onTap: () async {
                                        analytics.logEvent(name: 'med_freq_rest_days_tapped');
                              ...
                              MedicationFrequencyFormSectionLayout(
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    trailing: const Icon(Icons.chevron_right),
                                    onTap: () {
                                      analytics.logEvent(name: 'med_freq_pilll_install_tapped');
