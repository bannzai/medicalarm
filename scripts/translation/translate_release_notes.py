...
def translate_with_retry(i, lang, ja_text):
    ...
    try:
        ...
        app_release_note = translate_text(lang, ja_text)
...
for lang in langs:
    ...
    filepath = os.path.join(FASTLANE_METADATA_DIR, lang, "release_notes.txt")
...
"Translate and put app store app release_note"
