...
struct OpenAlarmAppIntent: LiveActivityIntent {
  ...
  static var title: LocalizedStringResource = "Open Medicalarm"
  static var description = IntentDescription("Opens the Medicalarm")
...
struct StopMedicationAlarmIntent: LiveActivityIntent {
  ...
  static var description = IntentDescription("服薬アラームを停止する")
